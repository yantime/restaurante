...
def generar_comprobante(tipo_de_comprobante: int, tipo_documento: str, numero_documento: str, pedido_id: int):
    ...
    validacioComprobante = Comprobante.objects.filter(pedido=pedido.id).first()
    if validacioComprobante is not None:
    ...
    cliente_email = 'yanchota@gmail.com'
    ...
    for detalle in detalle_pedido:
        ...
        stock: Stock = detalle.stock_id
        # Extraigo el plato de ese stock
        plato: Plato = stock.plato_id
